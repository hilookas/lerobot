...
for rows in get_episode():
    ...
    # fig, ax = plt.subplots()
    # ax.plot(action_base_cumsum[:, 0][::30])
    # ax.plot(action_base_cumsum[:, 1][::30])

    # fig, ax = plt.subplots(2, 1)
    # ax[0].plot(action_base_cumsum[:, 0])
    # ax[0].plot(action_base_cumsum_smoothed[:, 0])
    # ax[1].plot(action_base[:, 0])
    # ax[1].plot(action_base_smoothed[:, 0])
    # fig.savefig("smoothed_action_base_0.pdf", bbox_inches="tight", pad_inches=0)

    # fig, ax = plt.subplots(2, 1)
    # ax[0].plot(action_base_cumsum[:, 1])
    # ax[0].plot(action_base_cumsum_smoothed[:, 1])
    # ax[1].plot(action_base[:, 1])
    # ax[1].plot(action_base_smoothed[:, 1])
    # fig.savefig("smoothed_action_base_1.pdf", bbox_inches="tight", pad_inches=0)
